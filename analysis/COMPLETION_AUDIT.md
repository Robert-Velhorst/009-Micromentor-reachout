...
| Local API resists Host-header rebinding | The server accepts local hosts, configured exact hosts, and the launcher's exact current ngrok hostname; another ngrok hostname receives HTTP 421 even while tunnel authentication is enabled. | Proven |
