...
| Windows upgrade/data safety | Complete | migration, DPAPI encryption, owned-process stop, and byte-preserving reinstall in release gate |
| Live ngrok plus HAI | Complete | bounded installed-launcher HTTPS acceptance in final report |
